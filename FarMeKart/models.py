...
class UserPro(models.Model):
	farmers_name=models.ForeignKey(ExtPro,on_delete=models.CASCADE)
...
class Cart(models.Model):
	user=models.ForeignKey(ExtPro,on_delete=models.CASCADE)
	vegpro=models.ForeignKey(Vegpro,on_delete=models.CASCADE)
...
class Myorders(models.Model):
	...
	is_status=models.IntegerField(default=0)
	user=models.ForeignKey(UserPro,on_delete=models.CASCADE,null=True)
